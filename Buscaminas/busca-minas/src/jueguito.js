...
function applyCustomGame () {
  try {
    ...
    if (hasNonDigits.test(customGridWidth)) {
      document.getElementById("modal-msg").innerHTML = "Largo invalido.";
      return;
    }
    if (hasNonDigits.test(customGridHeight)) {
      document.getElementById("modal-msg").innerHTML = "Alto invalido.";
      return;
    }
    if (hasNonDigits.test(customMaxMines)) {
      document.getElementById("modal-msg").innerHTML = "Numero de minas invalido.";
      return;
    }

    if (customGridWidth < 6) {
      document.getElementById("modal-msg").innerHTML = "Inserta un Largo valido.";
      return;
    }
    if (customGridHeight < 6) {
      document.getElementById("modal-msg").innerHTML = "Inserta un Alto valido.";
      return;
    }
    if (customGridWidth > 64) {
      document.getElementById("modal-msg").innerHTML = "Inserta un largo por defecto.";
      return;
    }
    if (customGridHeight > 64) {
      document.getElementById("modal-msg").innerHTML = "Inserta un altura por defecto.";
      return;
    }

    if (customMaxMines > customGridWidth * customGridHeight - 9) {
      document.getElementById("modal-msg").innerHTML = "Muchas minas";
      return;
    }
    if (customMaxMines < 1) {
      document.getElementById("modal-msg").innerHTML = "Pocas minas";
      return;
    }
    ...
    document.getElementById("modal-msg").innerHTML = "Error";
    console.log(err);
  }
}

window.onclick = function(event) {
  if (event.target == document.getElementById("Personaliza")) {
    closeModal();
  } 
}
